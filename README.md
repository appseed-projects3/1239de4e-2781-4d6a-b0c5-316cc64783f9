...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-21 10:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1239de4e-2781-4d6a-b0c5-316cc64783f9.git
$ cd 1239de4e-2781-4d6a-b0c5-316cc64783f9
```
